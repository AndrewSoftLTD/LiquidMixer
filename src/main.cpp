...
int buttonPin = 8;
OneButton button0(buttonPin, false, true);


// MENU ARRAY 
// First number in array = amount of menu items in root layer. Same goes for next layer. 
//(Example: first value in array is 4. This means Layer 0 has 4 menu items. Layer 1 has only 2 menu items.)
// First number infront of menu text is the layer number that item points to. (Example: 1_Rotation points to 
//Layer 1)
// Second number infront of menu text is the number of the value connected to that menu item 
//in the values array. (Example: 15Direction points to position 5 in the values array)

String menu[] = {"4","01_Rotation","056Active","03_Watches","04_Item4",       // Layer 0
